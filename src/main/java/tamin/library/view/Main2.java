...
public class Main2 {
    public static void main(String[] args) {
        ...
        Book book2 = new Book();
        book2.setTitle("The Consequence Of Crimes").
        ...
        Book book3 = new Book();
        book3.setTitle("The Bright Nights").
        ...
        Book book4 = new Book();
        book4.setTitle("The Sun Also Rises").
        ...
        Book book5 = new Book();
        book5.setTitle("The Old Man And Sea").
        ...
        CD cd1 = new CD();
        cd1.setTitle("Nothing Else Matter")
